...
export const metadata: Metadata = {
  title: 'Demo Cumpleaños Premium - Tema Western | Web Invitations',
  description: 'Demostración del paquete premium para cumpleaños infantiles tema western ($499) - Con música y galería',
  keywords: ['cumpleaños infantil', 'western', 'premium', 'música', 'galería', 'invitación digital', 'vaqueros'],
}
...
export default function PremiumCumpleanosDemoLayout({
  ...
  return (
    <div className="min-h-screen">
      {/* Badge premium con gradiente western */}
      <div className={`bg-gradient-to-r ${premiumDemoData.premium.color} text-white text-center py-3 relative z-50 shadow-lg`}>
        ...
        <div className="text-xs text-blue-100 mt-1">
          🎵 Música del Oeste • 🖼️ Galería Western • ⭐ Efectos Especiales
        </div>
      </div>
