    ...
    <section className="py-16 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {premiumDemoData.padrinos && premiumDemoData.padrinos.padrinos && Array.isArray(premiumDemoData.padrinos.padrinos) && premiumDemoData.padrinos.padrinos.map((padrino, index) => (
            <div 
              key={index}
            ...
            >
              ...
              <div className="text-center mb-4">
                {padrino.names && Array.isArray(padrino.names) && padrino.names.map((name, nameIndex) => (
